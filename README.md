...
The website features seven pages that are accessible from the navigation bar (home page, project pages, contact form. There is also a success page that displays once the user has filled in and pressed sent on the contact form.
...
#### Project Pages 1, 2, 3, 4
- Main Heading (h1): Main project "IKNW, Mini goes Wild, KA_YO_Prototype, Illustrations"
- Subheadings (h2): "Projects"
-  Subheadings (h3): Portfolio Section "IKNW, Mini goes Wild, KA_YO_Prototype, Illustrations"
- Subheadings (h4): "Let's Connect"
